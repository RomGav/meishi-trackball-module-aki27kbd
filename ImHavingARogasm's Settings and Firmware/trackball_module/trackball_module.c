...
// Trackball speed or DPI
// Default values are { 250, 500, 750, 1000, 1250 }
...
// Scrolling TRACKBALL speed
// Default values are { 1, 2, 3, 4, 5, 6 } with 6 being the slowest
#ifndef COCOT_SCROLL_DIVIDERS
#    define COCOT_SCROLL_DIVIDERS { 4, 5, 6 }
